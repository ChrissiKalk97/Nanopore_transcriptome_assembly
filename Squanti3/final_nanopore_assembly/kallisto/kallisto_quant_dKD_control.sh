...
kallisto quant -i /scratch/fuchs/agschulz/kalk/Squanti3/kallisto/dKD_control/final/index/kallisto_dKD_control\
 -o /scratch/fuchs/agschulz/kalk/Squanti3/kallisto/dKD_control/final/quant/$(basename $reads _trimmomatic_crop_75_slow_2_threads.fastq)\
 -b 100\
 --single\
 -s 1\
 -l 75\
