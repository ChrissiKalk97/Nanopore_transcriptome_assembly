...
spack load gffread
transcriptome_assembly=/scratch/fuchs/agschulz/kalk/star/filtered_Ensembl_reference/Ensembl_equality_and_TSL_filtered.gtf 
...
spack load kallisto
kallisto index -i /scratch/fuchs/agschulz/kalk/Squanti3/kallisto/dKD_control/final/index/ref/reference\
 $transcriptome_fasta
